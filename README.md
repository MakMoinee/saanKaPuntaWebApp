# Saan Ka Punta Web App
## Installation Instructions
- Download php 7.4+ in the php official page
- Download latest composer
- Install the downloaded composer
- After successfully installing composer, clone this project using git bash by this command `git clone ``https://github.com/MakMoinee/saanKaPuntaWebApp.git`` `
- Go to the clone repository directory by opening cmd > `cd saanKaPuntaWebApp`
