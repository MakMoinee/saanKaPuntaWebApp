...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html">Saan Ka Punta</a>
                ...
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-8 ftco-animate">
                        <div class="text w-100 text-center">
                            <h1 class="mb-4">We Make Sure You'll Be Guided</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-8 ftco-animate">
                        <div class="text w-100 text-center">
                            <h1 class="mb-4">The Best Virtual Guide</h1>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-md-0 mb-4">
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li><a target="_blank"
                                                        href="https://www.termsandconditionsgenerator.com/live.php?token=d0QnZC2tjwnVatiiy12EPvnApkKuZJ3t"
                                                        class="py-1 d-block">Terms &amp; Conditions</a>
                                                </li>
                                                <li><a target="_blank"
                                                        href="https://www.privacypolicygenerator.info/live.php?token=Ipdccj7PL9MBnKmCz0QYlakTTUkPSvzE"
                                                        class="py-1 d-block">Policies</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
